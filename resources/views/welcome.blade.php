        ...
        tailwind.config = {
            theme: {
                extend: {
                    ...
                    colors: {
                        // Kustomisasi warna utama agar konsisten
                        primary: {
...
<body class="font-sans antialiased text-gray-900 bg-gray-50">
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-grow">
            <section class="container mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-32 text-center">
            ...
            <section class="bg-gray-50 py-20">
                <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div class="mt-8">
                        <a href="{{ Route::has('login') ? (Auth::check() ? route('dashboard') : route('register.show')) : Route('login.show') }}"
                            class="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rsounded-md shadow-sm text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 text-lg transition duration-150 ease-in-out">
                            {{ Auth::check() ? 'Buka Dashboard' : 'Mulai Gratis Sekarang' }}
                        </a>
                    </div>
                </div>
        ...
        <footer class="bg-white border-t">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center">
                <p class="text-sm text-gray-500">
                    &copy; {{ date('Y') }} {{ config('app.name', 'BrokerIoT') }}
                </p>
            </div>
        </footer>
